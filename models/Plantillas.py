...
class Plantilla(models.Model):
    ...
    # -----
    tipo_documento = fields.Selection(select_documento, string="Tipo Documento:", required=True)
    normatividad = fields.Selection(select_normatividad, string="Normatividad:", required=True)
    # los datos de programa se podrian heredar, pendiente
    ...
    # subir archivo field
    nombre_documento = fields.Char(string="Nombre Documento:", required=True, )
